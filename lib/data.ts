...
export const hotelDetails = {
  name: "Bonté de l'Eternel",
  location: "Parakou, Bénin",
  address: "Quartier xxxxxxxxx, Parakou",
  phone: "+229 23 61 00 00",
  email: "[EMAIL_ADDRESS]",
  description: "L'élégance au cœur de Parakou. Le Bonté de l'Eternel allie le charme de la tradition africaine au confort moderne pour un séjour inoubliable."
};
