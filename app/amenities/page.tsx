...
export const metadata: Metadata = {
    title: "Restaurant & Détente — Majestic Hotel Parakou",
    description: "Savourez une cuisine locale et internationale au Majestic Hotel. Profitez de notre piscine et de nos espaces de détente au cœur de Parakou.",
};
