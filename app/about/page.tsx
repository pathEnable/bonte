...
export const metadata: Metadata = {
    title: "Notre Histoire — Bonté de l'Eternel Hotel",
    description: "Découvrez l'histoire et l'âme du Bonté de l'Eternel Hotel à Parakou. Un établissement de tradition alliant modernité et hospitalité béninoise.",
};
