...
export const metadata: Metadata = {
  title: "Offres & Forfaits — Majestic Hotel Parakou",
  description: "Profitez de nos forfaits exclusifs au Majestic Hotel : Business, Famille ou Détente. Les meilleurs tarifs pour votre séjour à Parakou.",
};
