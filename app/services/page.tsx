...
export const metadata: Metadata = {
  title: "Nos Services — Majestic Hotel Parakou",
  description: "Découvrez nos services premium : conciergerie, navette, Wi-Fi haut débit et assistance 24/7 pour un séjour parfait à Parakou.",
};
