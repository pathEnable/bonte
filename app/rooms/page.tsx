...
export const metadata: Metadata = {
    title: "Nos Chambres & Suites — Majestic Hotel Parakou",
    description: "Choisissez parmi nos chambres climatisées ou ventilées à Parakou. Confort, Wi-Fi gratuit et service de qualité pour vos séjours au Bénin.",
};
